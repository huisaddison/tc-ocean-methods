...
gridTempProf = cat(2, A.gridTempProf, B.gridTempProf, C.gridTempProf, D.gridTempProf);
...
intStart=A.intStart;
intEnd=A.intEnd;
save(['./Data/gridTempProf.mat'], 'profLatAggrSel','profLongAggrSel','profYearAggrSel','profJulDayAggrSel','profFloatIDAggrSel','profCycleNumberAggrSel','gridTempProf','intStart','intEnd','-v7.3');
