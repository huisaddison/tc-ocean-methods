...
betaGrid = zeros([size(latGrid),20]);
...
for iGrid = 1:nGrid
    ...
    gridTempProfWindow = gridTempProf(idx)';
    ...
    betaGrid(iGridSub1,iGridSub2,:) = betaWindow;
    parfor_progress;
...
save(['./Results/meanField_',num2str(windowSize),'_',num2str(minNumberOfObs),'.mat'],'betaGrid','latGrid','longGrid','midJulDay', '-v7.3');
